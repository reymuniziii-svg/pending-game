...
export const MARIA_CHAIN_EVENTS: GameEvent[] = [
  ...
  {
    id: 'maria_license_renewal_clerk',
  ...
  {
    id: 'maria_chain_wait_life',
    title: 'Life in the Meantime',
    description: 'You choose to stay with DACA and wait. Life goes on—renewals every two years, the news every morning, the quiet hope that something will change. Miguel holds your hand. "We build a life inside the lines they give us," he says.',
    sceneType: 'home',
    timing: { type: 'triggered' },
    conditions: [],
    weight: 0,
    ...
    choices: [
      {
        id: 'build_within_limits',
        text: 'Build a full life within the limits',
        outcomes: [
          { type: 'flag-set', target: 'chose_daca_wait', value: true },
          { type: 'stat-change', target: 'stress', value: -5 },
          { type: 'stat-change', target: 'communityConnection', value: 10 },
        ],
        outcomeText: 'You pour yourself into your classroom, your marriage, your community. The uncertainty never leaves, but neither does the love. You are still here. You are still you.',
        isRecommended: true,
      },
      {
        id: 'watch_the_news',
        text: 'Keep one eye on every policy headline',
        outcomes: [
          { type: 'flag-set', target: 'chose_daca_wait', value: true },
          { type: 'stat-change', target: 'stress', value: 10 },
        ],
        outcomeText: 'Every court ruling, every headline becomes personal. You refresh the news like a wound you keep touching. But you stay ready—whatever comes.',
      },
    ],
    tags: ['daca', 'life', 'waiting'],
    isRepeatable: false,
    isMandatory: false,
    priority: 5,
  },
  {
    id: 'maria_chain_consular_research',
    title: 'Weighing the Gamble',
    description: 'You research the direct consular route for weeks. Forums full of people stuck in Ciudad Juárez. Stories of ten-year bars triggered at the interview window. Miguel reads over your shoulder, his jaw tight.',
    sceneType: 'home',
    timing: { type: 'triggered' },
    conditions: [],
    weight: 0,
    ...
    choices: [
      {
        id: 'choose_safer_waiver',
        text: 'Step back and pursue the I-601A waiver instead',
        outcomes: [
          { type: 'flag-set', target: 'marriage_path_chosen', value: 'i601a' },
          { type: 'stat-change', target: 'stress', value: -10 },
        ],
        outcomeText: '"I\'m not gambling our future on a maybe," you tell Miguel. You call the lawyer back and ask about the waiver. The safer road. The longer road. The one with a way home.',
        nextEventId: 'maria_chain_i601a_decision',
        isRecommended: true,
      },
      {
        id: 'risk_it',
        text: 'Book the trip anyway',
        outcomes: [
          { type: 'flag-set', target: 'departed_us', value: true },
          { type: 'flag-set', target: 'unlawfulPresenceDays', value: 400 },
          { type: 'stat-change', target: 'stress', value: 35 },
        ],
        outcomeText: 'You can\'t wait years. You fly to Mexico for the interview—no approved waiver in hand. The moment you cross, a clock you can\'t see starts ticking. Everything now rides on a stranger behind glass.',
        nextEventId: 'maria_ending_mexico',
        isDangerous: true,
      },
    ],
    tags: ['immigration', 'risk', 'decision'],
    isRepeatable: false,
    isMandatory: false,
    priority: 7,
  },
  {
    id: 'maria_chain_miguel_worried',
    title: 'Outside the Office',
    description: 'Miguel stands with you on the sidewalk outside the lawyer\'s office. "Talk to me," he says. "Whatever it is, we face it together. But we can\'t face nothing."',
    sceneType: 'street',
    timing: { type: 'triggered' },
    conditions: [],
    weight: 0,
    ...
    choices: [
      {
        id: 'go_back_in',
        text: 'Take a breath and go back inside',
        outcomes: [
          { type: 'flag-set', target: 'returned_to_lawyer', value: true },
          { type: 'stat-change', target: 'stress', value: -5 },
          { type: 'relationship-change', target: 'miguel', value: 10 },
        ],
        outcomeText: 'You squeeze his hand and turn around. The lawyer looks up, unsurprised. "Ready?" she asks. You nod. This time you stay.',
        nextEventId: 'maria_chain_lawyer_options',
        isRecommended: true,
      },
      {
        id: 'need_more_time',
        text: 'Tell him you need more time',
        outcomes: [
          { type: 'flag-set', target: 'marriage_path_stalled', value: true },
          { type: 'stat-change', target: 'stress', value: 15 },
          { type: 'relationship-change', target: 'miguel', value: -5 },
        ],
        outcomeText: '"I just need time," you say again. He nods, but something in him deflates. The conversation will keep waiting for you. So will the decision.',
      },
    ],
    tags: ['relationship', 'immigration'],
    isRepeatable: false,
    isMandatory: false,
    priority: 6,
  },
  {
    id: 'maria_chain_financial_pressure',
    title: 'The Math of Hope',
    description: 'At the kitchen table you and Miguel run the numbers again. The retainer. The filing fees. The travel. The months without certainty. Hope, it turns out, has a price tag.',
    sceneType: 'home',
    timing: { type: 'triggered' },
    conditions: [],
    weight: 0,
    ...
    choices: [
      {
        id: 'save_aggressively',
        text: 'Commit to saving every spare dollar for the waiver',
        outcomes: [
          { type: 'flag-set', target: 'saving_for_waiver', value: true },
          { type: 'stat-change', target: 'stress', value: 10 },
        ],
        outcomeText: 'You pick up weekend tutoring. Miguel takes extra shifts. Slowly the fund grows. A few months later, you sit back down with the lawyer—ready this time.',
        nextEventId: 'maria_chain_i601a_decision',
        isRecommended: true,
      },
      {
        id: 'shelve_the_waiver',
        text: 'Put the waiver on hold indefinitely',
        outcomes: [
          { type: 'flag-set', target: 'marriage_path_chosen', value: 'wait' },
          { type: 'stat-change', target: 'stress', value: 5 },
        ],
        outcomeText: 'Not now. Maybe not for years. You keep your DACA, keep your job, keep waiting. The folder goes in a drawer you try not to open.',
      },
    ],
    tags: ['money', 'immigration', 'decision'],
    isRepeatable: false,
    isMandatory: false,
    priority: 5,
  },
  {
    id: 'maria_chain_submit_anxiety',
    title: 'The Last Hesitation',
    description: 'The package sits by the door for a week. Everything is ready. Everything is checked. And still your hand won\'t reach for it. What if it\'s not enough? What if asking opens a door that can\'t be closed?',
    sceneType: 'home',
    timing: { type: 'triggered' },
    conditions: [],
    weight: 0,
    ...
    choices: [
      {
        id: 'finally_submit',
        text: 'Take a breath and file it',
        costs: [{ type: 'money', amount: 630, description: 'I-601A filing fee' }],
        outcomes: [
          { type: 'finance-subtract', target: 'I-601A Filing Fee', value: 630 },
          { type: 'flag-set', target: 'i601a_submitted', value: true },
        ...
        outcomeText: 'You hand it to the clerk before you can change your mind. "Now we wait," the lawyer says. The hardest part is done—and the hardest part has only begun.',
        nextEventId: 'maria_chain_i601a_wait_1',
        isRecommended: true,
      },
      {
        id: 'withdraw_for_now',
        text: 'You\'re not ready—put it away',
        outcomes: [
          { type: 'flag-set', target: 'i601a_delayed', value: true },
          { type: 'stat-change', target: 'stress', value: 15 },
        ],
        outcomeText: 'The package goes back in the drawer. Miguel doesn\'t ask. He doesn\'t have to. The fear won this round. There will be other rounds.',
      },
    ],
    tags: ['immigration', 'forms', 'stress'],
    isRepeatable: false,
    isMandatory: false,
    priority: 6,
  },
  {
    id: 'maria_chain_rfe_response',
    title: 'Answering the RFE',
    description: 'The Request for Evidence is a second chance disguised as a setback. The lawyer is blunt: "They want proof Miguel would truly suffer. Numbers won\'t do it. We need the human cost on paper."',
    sceneType: 'uscis',
    interruptPriority: 'important',
    timing: { type: 'triggered' },
    conditions: [],
    ...
    choices: [
      {
        id: 'gather_full_evidence',
        text: 'Get the psychological evaluation and respond fully',
        costs: [{ type: 'money', amount: 1200, description: 'Evaluation and RFE response' }],
        outcomes: [
          { type: 'finance-subtract', target: 'RFE Response', value: 1200 },
          { type: 'flag-set', target: 'i601a_approved', value: true },
          { type: 'stat-change', target: 'stress', value: -15 },
        ],
        outcomeText: 'Miguel sits for the evaluation he resisted for so long. His honesty fills the gap the numbers left. Weeks later, the lawyer calls: "Approved. We\'re going to Mexico."',
        nextEventId: 'maria_chain_consular_interview',
        isRecommended: true,
      },
      {
        id: 'cannot_respond',
        text: 'You can\'t face another round—let it lapse',
        outcomes: [
          { type: 'flag-set', target: 'i601a_abandoned', value: true },
          { type: 'stat-change', target: 'stress', value: 25 },
        ],
        outcomeText: 'The deadline passes. The waiver is denied for abandonment. You are exactly where you started—DACA, uncertainty, and the drawer you try not to open.',
      },
    ],
    tags: ['immigration', 'uscis', 'evidence'],
    isRepeatable: false,
    isMandatory: false,
    priority: 7,
  },
  {
    id: 'maria_ending_mexico',
    title: 'A Life in Mexico',
    description: 'The years settle. You speak Spanish all day now, the accent of your childhood returning like a song you forgot you knew. Miguel visits when he can. You teach again—different students, same calling. It is not the life you planned. It is, somehow, still a life.',
    sceneType: 'home',
    timing: { type: 'triggered' },
    conditions: [],
    weight: 0,
    ...
    choices: [
      {
        id: 'accept_mexico_life',
        text: 'Make peace with where you are',
        outcomes: [
          { type: 'flag-set', target: 'ending_mexico_reached', value: true },
          { type: 'end-game', target: 'maria_mexico' },
        ],
        outcomeText: 'The country that was a fragment of memory becomes home again. You carry America inside you—its language, its students, its promises kept and broken. You are not who you would have been. But you are still becoming.',
      },
    ],
    tags: ['ending', 'mexico', 'reflection'],
    isRepeatable: false,
    isMandatory: false,
    priority: 9,
  },
  {
    id: 'maria_chain_long_path_back',
    title: 'The Ten-Year Road',
    description: 'Every lawyer says the same thing in different words: there may be a path back, but it is measured in years, not months. A waiver. A wait. A hope held at arm\'s length across a border.',
    sceneType: 'home',
    timing: { type: 'triggered' },
    conditions: [],
    weight: 0,
    ...
    choices: [
      {
        id: 'commit_to_the_wait',
        text: 'Commit to the long road home',
        outcomes: [
          { type: 'flag-set', target: 'ending_long_path_reached', value: true },
          { type: 'end-game', target: 'maria_long_wait' },
        ],
        outcomeText: 'You file what you can and begin counting—not days, but years. Miguel marks each anniversary with a phone call and a promise. The road back is long. You decide to walk it anyway.',
      },
    ],
    tags: ['ending', 'waiting', 'reflection'],
    isRepeatable: false,
    isMandatory: false,
    priority: 9,
  },
